...
public class VerifyCode {
	...
	private static String codes = "23456789abcdefghjkmnopqrstuvwxyzABCDEFGHJKMNPQRSTUVWXYZ";	// 去掉容易混淆的字符
	// 背景色
	...
	public void drawImage(OutputStream outputStream) {
		...
		// 绘制边框
		g2.setColor(Color.GRAY);// 设置画笔为灰色
		g2.drawRect(0, 0, width-1, height-1);// 绘制边框
